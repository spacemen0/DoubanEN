  ...
  return (
    <div className="flex flex-col">
      <div className="mt-12 flex items-center justify-center max-w-screen md:mt-16">
        ...
        <div className="mr-2 flex flex-col md:max-w-screen-sm lg:max-w-screen-md xl:max-w-screen-lg">
          ...
          <div className="mt-2 md:text-xl">
            <p className="text-Neutral-Mild">
              {bannerText + " "}
              <Link to="/contribute" className="text-Neutral-Strong">
                {bannerLinkText + " "}
              </Link>
            </p>
          </div>
...
function SiteStatus() {
  return (
    <div className="mx-auto mt-6 px-4 lg:mt-12">
