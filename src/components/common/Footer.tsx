...
export function Footer() {
  return (
    <div className="mt-8 flex flex-col items-start justify-center rounded-md bg-gray-400 pt-4 pb-8 pl-6 text-Neutral-Strong md:flex-row md:items-center md:pl-0">
