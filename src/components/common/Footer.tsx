...
export function Footer() {
  return (
    <div className="mt-2 flex flex-col items-start justify-center rounded-md bg-gray-100 pt-4 pb-8 pl-6 text-Neutral-Strong md:flex-row md:items-center md:pl-0">
