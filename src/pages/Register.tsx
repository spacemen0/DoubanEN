...
export default function Register() {
    ...
    return (
        <>
            <PageHeader/>
            <RegisterForm onSubmit={handleRegister} formData={formData} onChange={handleInputChange}/>
        </>
    );
}
...
function RegisterForm(props: {
    ...
    formData: { password: string; password_repeat: string; email: string; username: string },
